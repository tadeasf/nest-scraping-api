...
describe('ArticlesController Integration', () => {
  ...
  describe('getArticles', () => {
    ...
    it('should handle database errors gracefully', async () => {
      ...
      await expect(controller.getArticles(1, 10)).rejects.toThrow(
  ...
  describe('getStats', () => {
    ...
    it('should handle database errors gracefully', async () => {
      ...
      articleRepository.count = jest
        .fn()
        .mockRejectedValue(new Error('Database count failed'));
  ...
  describe('getArticle', () => {
    ...
    it('should handle database errors gracefully', async () => {
      ...
      articleRepository.findOne = jest
        .fn()
  ...
  describe('getArticlesBySource', () => {
    ...
    it('should handle non-existent source', async () => {
      const result = await controller.getArticlesBySource(
        'non-existent',
        1,
        10,
      );
    ...
    it('should handle database errors gracefully', async () => {
      ...
      await expect(
        controller.getArticlesBySource('idnes.cz', 1, 10),
  ...
  describe('getArticlesByDate', () => {
    ...
    it('should throw error for invalid date format', async () => {
      await expect(
        controller.getArticlesByDate('invalid-date', 1, 10),
    ...
    it('should handle database errors gracefully', async () => {
      ...
      await expect(
        controller.getArticlesByDate('2024-01-01', 1, 10),
      ).rejects.toThrow('Database query failed');
  ...
  describe('getRecentArticles', () => {
    ...
    it('should handle database errors gracefully', async () => {
      ...
      await expect(controller.getRecentArticles(7, 1, 10)).rejects.toThrow(
        'Database query failed',
      );
  ...
  describe('triggerScraping', () => {
    ...
    it('should handle scraping service errors', async () => {
      ...
      scrapingService.scrapeImmediately = jest
        .fn()
